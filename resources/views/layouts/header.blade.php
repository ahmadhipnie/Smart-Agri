        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('backend/logo/SA-logo.png')}}" alt="">
                <img class="logo-compact" src="{{ asset('backend/logo/SA-text.png')}}" alt="">
                <img class="brand-title" src="{{ asset('backend/logo/SA-text.png')}}" alt="">
            </a>
